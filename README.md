...
I specialize in penetration testing, developing custom offensive tools, breaking complex systems and thinking like an adversary to secure infrastructure (basically _red teaming_). I am also the co-founder of [White Hats SC](https://whitehats.pwr.edu.pl/) at WUST :chart:

- **Core Specialization** - Offensive Security Research, AppSec and Red Teaming.
- 🛠️ **Tooling** - I develop offensive tools and automations.
- 🔭 **Current Focus** - AppSec, Bug Bounty & Offensive Tool Development.
- 💻 **Tech Stack** - Python, Bash, Golang and JavaScript.
- **Archives** - I maintain forks of cool projects over at [arqsz-mirrors](https://github.com/arqsz-mirrors/).

I also sometimes write articles about my research or just some of my ideas on [arqsz.net](https://arqsz.net).
...
[![https://img.shields.io/badge/%20-Arqsz-657786?style=for-the-badge&labelColor=657786&logo=x](https://img.shields.io/badge/%20-Arqsz-657786?style=for-the-badge&labelColor=657786&logo=x)](https://x.com/Arqsz)

### 📫 Let's connect

If you want to collaborate on a cybersec project or just say hi:

- DM me at [Twitter/X](https://x.com/arqsz)
...
* **[gcheck](https://github.com/TheArqsz/gcheck)** ![Python](https://img.shields.io/badge/Python-ED8B00?style=flat-square&logo=python&logoColor=white&color=blue) - Google/Firebase credentials validator.
...
> Repository updated at Mon Aug 10 01:57:11 UTC 2026 
